...
wdir <- paste0("C:/Users/alagl/OneDrive - Wilmar International Limited/Desktop/IPP Research/Projects/CSCAC")
setwd(wdir)
...
p1 = plot_pca(Tr_adjTe_pca, 1, 2, FALSE, Tr_adjTe$batch, Tr_adjTe$class, c(name, "Batch", "Class"))+theme_Publication(base_size = 18)+  ggplot2::theme(legend.position = "bottom", legend.direction = "horizontal")
